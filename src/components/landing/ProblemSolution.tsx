        ...
        <section className="py-16 sm:py-24 relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="mb-12 sm:mb-16">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-900 tracking-tight mb-4">Bridging the gap between<br className="hidden sm:block" />surplus and scarcity.</h2>
                    <p className="text-base sm:text-lg md:text-xl text-gray-500 max-w-2xl">Large quantities of usable medicine are discarded daily while many struggle to access essential care.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Card 1 */}
                    <div className="glass-card p-6 sm:p-8 rounded-3xl hover:-translate-y-1 transition-transform duration-300">
                    ...
                    {/* Card 2 */}
                    <div className="glass-card p-6 sm:p-8 rounded-3xl hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
